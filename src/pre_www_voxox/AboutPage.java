...
@Test
public void C21315() throws Exception {
  driver.get(baseUrl + "/");
...
@Test
public void C21316() throws Exception {
  driver.get(baseUrl + "/");
  driver.findElement(By.id("drop2")).click();
  driver.findElement(By.xpath("(//a[contains(text(),'About')])[2]")).click();
...
@Test
public void C21317() throws Exception {
  driver.get(baseUrl + "/");
  driver.findElement(By.id("drop2")).click();
  driver.findElement(By.xpath("(//a[contains(text(),'About')])[2]")).click();
...
@Test
public void C21318() throws Exception {
  driver.get(baseUrl + "/");
  driver.findElement(By.id("drop2")).click();
  driver.findElement(By.xpath("(//a[contains(text(),'About')])[2]")).click();
...
@Test
public void C21319() throws Exception {
  driver.get(baseUrl + "/");
  driver.findElement(By.id("drop2")).click();
  driver.findElement(By.xpath("(//a[contains(text(),'About')])[2]")).click();
...
@Test
public void C21320() throws Exception {
  driver.get(baseUrl + "/");
  driver.findElement(By.id("drop2")).click();
  driver.findElement(By.xpath("(//a[contains(text(),'About')])[2]")).click();
