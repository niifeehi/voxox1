...
public class Sidebarlinks {
  ...
  @Test
  public void C37548() throws Exception {
    driver.get(baseUrl + "/");
  ...
  @Test
  public void C37549() throws Exception {
    driver.get(baseUrl + "/");
    // driver.findElement(By.id("drop2")).click();
    driver.findElement(By.linkText("Contact")).click();
    // driver.findElement(By.linkText("contact")).click();
  ...
  @Test
  public void C37550() throws Exception {
    driver.get(baseUrl + "/");
    // driver.findElement(By.id("drop2")).click();
    driver.findElement(By.linkText("Contact")).click();
  ...
  @Test
  public void C37551() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.linkText("Contact")).click();
  ...
  @Test
  public void C37552() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.linkText("Contact")).click();
  ...
  @Test
  public void C37553() throws Exception {
    driver.get(baseUrl + "/");
    driver.findElement(By.linkText("Contact")).click();
